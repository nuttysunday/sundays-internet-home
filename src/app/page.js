...
export default function Home() {
  return (
    <div>
        <p style={{ marginBottom:'2rem'}}>Hi, I'm Shivam Ghodke—yet another software engineer, currently pursuing my Master’s in Computer Science at NC State University, North Carolina. I’ve got a 3.6/4 GPA, and some of my favorite classes include Databases, Cloud Computing, Software Engineering, and Computer Networks. I’m set to graduate in May 2025—unless I mess up something along the way.</p>
