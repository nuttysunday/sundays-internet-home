  ...
  return (
    <Timeline>
      <TimelineItem>
        <TimelinePoint />
        <TimelineContent>
          <p>Feb 2024 - Present, Raleigh, NC, USA</p>
          <h1 >Software Developer (Graduate Research Assistant), Wilson College of Textiles, NCSU</h1>
          <p >
      ...
      <TimelineItem>
        <TimelinePoint />
        <TimelineContent>
          <p>Jan 2022 -  Feb 2022, Mumbai, India  </p>
          <h1>Software Developer, Freelancing</h1>
          <p >
      ...
      <TimelineItem>
        <TimelinePoint />
        <TimelineContent>
          <p>July 2021- Dec 2022, Hyderabad, India</p>
          <h1>Software Developer Intern, Ledger Forces Private Limited</h1>
          <p >
